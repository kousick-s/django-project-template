...
urlpatterns = patterns('',
    ...
    url(r'^tasks/newtask/(?P<user_id>[0-9]+)$', views.newtask,name="newtask"),
    url(r'^tasks/create/(?P<user_id>[0-9]+)$', views.savetask,name="createtasks"),
    url(r'^tasks/(?P<user_id>[0-9]+)$', views.tasks,name="movies"),
